...
SAFE-UDLM is a uniform discrete diffusion model trained on molecular Sequential Attachment-based Fragment Embedding ([SAFE](https://arxiv.org/abs/2310.10773)) representations for fragment-based molecule generation, and supports de novo generation, linker design, motif extension, scaffold decoration, hit generation, and lead optimization.

This model is ready for commercial use.

## License/Terms of Use:

Governing Terms: Use of this model is governed by the [NVIDIA Open Model License](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-open-model-license/). SAFE-UDLM source code is licensed under [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0). By using SAFE-UDLM, you accept the terms and conditions of this license.

Deployment Geography: Global

Use Case: SAFE-UDLM is a flexible generative AI tool for small molecule design in drug discovery. Its primary use cases include:
Generating novel molecules: SAFE-UDLM can create new, valid molecules from scratch (de novo design).
...
Property optimization: When paired with external scoring models or methods, SAFE-UDLM aids in designing molecules with specific desired properties, which is a critical step in developing effective drugs.

Release Date:
Github 04/07/2026 via https://github.com/Sailaukan/safe-udlm
...
|Describe how the model works|From the input of a molecular sequence in SAFE format, the transformer denoises uniformly corrupted token sequences over continuous discrete-diffusion timesteps until a valid molecule sequence is recovered.||  
...
|Licensing & Terms of Use|Governing Terms: Use of this model is governed by the [NVIDIA Open Model License](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-open-model-license/). SAFE-UDLM source code is licensed under [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0).|
...
|Use Case Restrictions|Abide by [NVIDIA Open Model License](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-open-model-license/). SAFE-UDLM source code is licensed under [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0).|  
